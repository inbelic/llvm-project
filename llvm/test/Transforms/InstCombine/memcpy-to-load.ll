...
; RUN: opt < %s -passes=instcombine -S                         | FileCheck %s --check-prefixes=CHECK,NOI64
; RUN: opt < %s -passes=instcombine -S -data-layout=n32        | FileCheck %s --check-prefixes=CHECK,NOI64
; RUN: opt < %s -passes=instcombine -S -data-layout=n32:64     | FileCheck %s --check-prefixes=CHECK,WITHI64
; RUN: opt < %s -passes=instcombine -S -data-layout=n32:64:128 | FileCheck %s --check-prefixes=CHECK,WITHI64
...
; WITHI64-NEXT:    [[TMP1:%.*]] = load i64, ptr [[S:%.*]], align 1
; WITHI64-NEXT:    store i64 [[TMP1]], ptr [[D:%.*]], align 1
; NOI64-NEXT:  call void @llvm.memcpy.p0.p0.i32(ptr noundef nonnull align 1 dereferenceable(8) [[D:%.*]], ptr noundef nonnull align 1 dereferenceable(8) [[S:%.*]], i32 8, i1 false)
; CHECK-NEXT:    ret void
;
...
; WITHI64-NEXT:    [[TMP1:%.*]] = load i64, ptr [[S:%.*]], align 1, !alias.scope [[META0:![0-9]+]], !noalias [[META3:![0-9]+]]
; WITHI64-NEXT:    store i64 [[TMP1]], ptr [[D:%.*]], align 1, !alias.scope [[META0]], !noalias [[META3]]
; NOI64-NEXT:  call void @llvm.memcpy.p0.p0.i32(ptr noundef nonnull align 1 dereferenceable(8) [[D:%.*]], ptr noundef nonnull align 1 dereferenceable(8) [[S:%.*]], i32 8, i1 false), !alias.scope [[META0:![0-9]+]], !noalias [[META3:![0-9]+]]
; CHECK-NEXT:    ret void
;
